...
########################################
shapes_base = {
    0: [4, 32, 320, 320], 1: [4, 64, 160, 160], 2: [4, 64, 160, 160], 3: [4, 128, 80, 80],
    4: [4, 128, 80, 80], 5: [4, 256, 40, 40], 6: [4, 256, 40, 40], 7: [4, 512, 20, 20],
    8: [4, 512, 20, 20], 9: [4, 512, 20, 20], 10: [4, 256, 20, 20], 11: [4, 256, 40, 40],
    12: [4, 512, 40, 40], 13: [4, 256, 40, 40], 14: [4, 128, 40, 40], 15: [4, 128, 80, 80],
    16: [4, 256, 80, 80], 17: [4, 128, 80, 80], 18: [4, 128, 40, 40], 19: [4, 256, 40, 40],
    20: [4, 256, 40, 40], 21: [4, 256, 20, 20], 22: [4, 512, 20, 20], 23: [4, 512, 20, 20]
    # No layer added
}
...
shapes_avgpool_all_fm = {
    ...
    20: [4, 256, 40, 40], 21: [4, 256, 20, 20], 22: [4, 512, 20, 20], 23: [4, 512, 20, 20],
    # added layers
    24: [4, 256, 1, 1], 25: [4, 128, 1, 1], 26: [4, 128, 1, 1], 27: [4, 512, 1, 1],
    # detection head
    28: [4, 3]
}
...
shapes_complex = {
    ...
    20: [4, 256, 40, 40], 21: [4, 256, 20, 20], 22: [4, 512, 20, 20], 23: [4, 512, 20, 20],
    # added layers
    24: [4, 128, 20, 20], 25: [4, 128, 40, 40], 26: [4, 128, 40, 40], 27: [4, 384, 40, 40],
    # detection head
    28: [4, 3]
}
