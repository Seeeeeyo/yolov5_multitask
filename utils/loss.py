...
class ComputeLoss:
    ...
    # Compute losses
    def __init__(self, model, autobalance=False, multitasks=True):
        ...
        if multitasks:
            # TODO add many cls losses as there are cls heads
            # classification loss
        ...
        self.CEloss = CEloss # classification loss
    ...
    def __call__(self, preds, targets, targets_cls, det_to_check, mosaic=False):  # predictions, targets, array of 0 and 1, meaning if
        ...
        # TODO later, add classification loss weight in hyp
        lbox *= self.hyp['box']
        lobj *= self.hyp['obj']
        lcls *= self.hyp['cls']
